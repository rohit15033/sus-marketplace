    ...
    <div class="hero-container">
        <header>
            <div class="header-logo">
                <a href="https://www.sampoernauniversity.ac.id"><img src="../../TestimonyAsset/su-logo-light.png" alt=""></a>
            </div>
    ...
    <div class="ultimate-testimony-container">
        <div class="testimony-container">
            <p>"The campus marketplace is a gem! Navigating the website was a breeze, and I found everything I needed
                quickly. The selection of products is impressive, and the quality is top-notch. The staff were friendly
