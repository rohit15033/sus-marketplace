<?php 
    ...
    {        
        ...
        if ($password == $confirmPassword) {
            ...
            $createUserQuery = "CREATE USER '$email'@'localhost' IDENTIFIED BY '$password'";
            ...
            $insertUserDataQuery = "INSERT INTO users (user_id, email, password) VALUES ('$user_id', '$email', '$hashedPassword')";
